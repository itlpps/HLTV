...
var getMatchMapStats = function (config) {
    return function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var m$, p$, matchId, halfsString, result, map, date, team1, team2, event, roundHistory, overtimeHistory, overview, playerStats, performanceOverview;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, (0, utils_1.fetchPage)("https://www.hltv.org/stats/matches/mapstatsid/".concat(id, "/-"), config.loadPage).then(scraper_1.HLTVScraper)];
                    case 1:
                        m$ = _b.sent();
                        return [4 /*yield*/, (0, utils_1.sleep)(1000)];
                    case 2:
                        _b.sent();
                        return [4 /*yield*/, (0, utils_1.fetchPage)("https://www.hltv.org/stats/matches/performance/mapstatsid/".concat(id, "/-"), config.loadPage).then(scraper_1.HLTVScraper)];
                    case 3:
                        p$ = _b.sent();
                        ...
                        overtimeHistory = getRoundHistory(m$, team1, team2, true);
...
function getRoundHistory($, team1, team2, isOvertime) {
    if (isOvertime === void 0) { isOvertime = false; }
    ...
    var outcomes = $('.round-history-team-row').toArray();
    if (isOvertime && outcomes.length === 2) {
        return [];
    }
    var team1Outcomes = outcomes[isOvertime ? 2 : 0]
        .find('.round-history-outcome')
        .toArray()
        .map(getOutcome);
    var team2Outcomes = outcomes[isOvertime ? 3 : 1]
        .find('.round-history-outcome')
        .toArray()
        .map(getOutcome);
